...
export default function ContactPage() {
  const [state, handleSubmit] = useForm("myzjykdw");
      ...
      <PageWrapper>
        <main className="min-h-screen bg-black text-white flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-4xl font-light mb-4">Thanks for contacting us!</h1>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="pt-4">
                      <button
                        ...
                        className="px-8 py-3 bg-transparent border border-white text-white rounded hover:bg-yellow-300 hover:text-black transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-black disabled:opacity-50 disabled:cursor-not-allowed"
                      >
