...
const Card = ({ title, description }) => {
  return (
    <div className="relative w-full h-[500px] overflow-hidden  border border-white  text-white px-3 lg:px-0">
      {/* Large screens: hover layout */}
      <div className="hidden lg:block group relative w-full h-full hover:bg-white cursor-pointer">
        {/* Header */}
      ...
      <div className="hidden md:flex lg:hidden w-full h-full flex-row">
        ...
        <div className="w-1/2 flex items-center justify-center p-4">
          <p className=" text-black text-xl font-semibold text-center">{description}</p>
        </div>
      </div>
      ...
      <div className="flex flex-col md:hidden w-full h-full">
        ...
        <div className="p- h-1/2 text-center pt-10">
          <h2 className="text-2xl font-semibold mb-4 text-black py-3">{title}</h2>
